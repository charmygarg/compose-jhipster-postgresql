...
import com.peiniau.jhipster.domain.Document;
import com.peiniau.jhipster.repository.DocumentRepository;
import com.peiniau.jhipster.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.peiniau.jhipster.domain.Document}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DocumentResource {
    ...
    public ResponseEntity<Document> updateDocument(@Valid @RequestBody Document document) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, , ENTITY_NAME, document.getId().toString()))
            .body(result);
    }
