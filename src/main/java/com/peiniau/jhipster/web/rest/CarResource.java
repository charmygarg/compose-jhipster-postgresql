...
import com.peiniau.jhipster.repository.CarRepository;
...
/**
 * REST controller for managing {@link com.peiniau.jhipster.domain.Car}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CarResource {
    ...
    public ResponseEntity<Car> updateCar(@Valid @RequestBody Car car) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, , ENTITY_NAME, car.getId().toString()))
            .body(result);
    }
